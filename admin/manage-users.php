...
$query1=mysqli_query($con,"delete from tblincidents where userId='$userid'");
...
<a href="user-incidents.php?uid=<?php echo htmlentities($row['id']);?>&&uname=<?php echo htmlentities($row['fullName']);?>" title="View User Complaints" class="btn btn-info  btn-xs">Complaints</a>
                                        </td>
