						...
						<li>
							<div class="dropdown">
								<a class="dropdown-toggle" href="#" data-toggle="dropdown">
									...
									<?php
$rt = mysqli_query($con,"select tblincidents.*,users.fullName as name from tblincidents join users on users.id=tblincidents.userId where tblincidents.status is null");
...
?>
											<div class="media">
												...
												<div class="media-body">
													...
													<p>Incident No.<a href="incident-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>"><?php echo htmlentities($row['complaintNumber']);?> at <small><?php echo htmlentities($row['regDate']);?></small> </a></p>
												</div>
											</div>
											<br><?php $cnt=$cnt+1; } ?>
										</li>
