...
if(isset($_POST['submit']))
{
	...
	header("Location: ../user/index.php"); // Redirect to user/index.php
...
<head>
	<title>IMS | User Regsitrations</title>
...
<div class="auth-wrapper">
	<div class="auth-content text-center">
				<h4>Incident management system <hr /><span style="color:#fff;"> User Registration</span></h4>
				<hr />
