...
<body>
      ...
      <div class="container-fluid ">
         <div class="row">
            <div class="col-sm-2 col-6">
               <a class="logo" href="index.php"><h1 style="font-size: 40px;color: white;">IMS</h1></a>
            </div>
            ...
            <div id="main_slider" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <h1 class="banner_taital">Report  Incident </h1>
                  ...
                  <div class="carousel-item">
                     <h1 class="banner_taital">Don't hesitate to report any incidents</h1>
                     <div class="read_bt"></div>
                     <div class="number_main">
   ...
   <div class="copyright_section">
      <div class="container">
         <p class="copyright_text">Incident Management System.</p>
      </div>
   </div>
